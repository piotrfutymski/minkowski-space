...
/// Maximum velocity magnitude accepted by the library.
///
/// Velocities are expressed in units where the speed of light is `1`. The
/// small margin below `1` keeps Lorentz-factor calculations numerically safe.
